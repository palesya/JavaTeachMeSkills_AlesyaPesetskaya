...
public class Main {
    public static void main(String[] args) {
        ...
        director1.setSubordinates(director2);
        director1.setSubordinates(worker1);
        director1.setSubordinates(worker2);
        director1.setSubordinates(worker3);
        director2.setSubordinates(worker4);
        director2.setSubordinates(director3);
        director3.setSubordinates(worker5);
